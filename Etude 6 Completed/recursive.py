...
def drawSquares(w, numSquares, width, height, xMod, yMod):
	...
	#Mid Right
        ...
        drawSquares(w, numSquares-1, width, height, xMod+0, yMod+0)
        drawSquares(w, numSquares-1, width, height, xMod+width, yMod+0)
        drawSquares(w, numSquares-1, width, height, xMod+0, yMod+height)
        drawSquares(w, numSquares-1, width, height, xMod+width*2, yMod+0)
        drawSquares(w, numSquares-1, width, height, xMod+width*2, yMod+height)
        drawSquares(w, numSquares-1, width, height, xMod+0, yMod+height*2)
        drawSquares(w, numSquares-1, width, height, xMod+width, yMod+height*2)
        drawSquares(w, numSquares-1, width, height, xMod+width*2, yMod+height*2)
